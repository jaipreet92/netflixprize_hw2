...
if __name__ == "__main__":
    ...
    absolute_deviation_matrix = deviation_util.get_deviation_from_mean_matrix(users_to_most_rated_movies_matrix)

    balltree.predict_using_balltree(raw_testing_data=raw_testing_data, absolute_deviation_matrix=absolute_deviation_matrix)
